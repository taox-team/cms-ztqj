...
var listPicManager = {
                ...
                if(res.success){
                    ...
                    for(var i=0;i<data.length;i++){
                        ...
                        str = str + '<li class="pic">'
                            +'<div class="img-box">'
                            +'<a href="zjgc-list.html?id='+obj.folderId+'&articleId='+obj.articleId+'">'
    ...
    getDeviceList:function(){
        var _this = this;
        $.ajax({
            url: 'http://' + location.host + '/api/menu/getMenuById?id=9',
            method:'get',
            success:function(res){
                if(res.success){
                    ...
                    for(var i=0;i<data.length;i++){
                        ...
                        str = str + '<li class="'+(_this.id == obj.folderId?'active':'')+'"><a href="zjgc-list.html?id='+obj.folderId+'&ename="+obj.ename>'+obj.name+'</a></li>';
                    }
